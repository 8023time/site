...
import type { IconWrapperProps } from "./base/data";
      ...
      <g fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2">
        ...
        <g>
          <path strokeDasharray="2" strokeDashoffset="2" d="M12 19v1M19 12h1M12 5v-1M5 12h-1">
            ...
            />
            <animate fill="freeze" attributeName="strokeDashoffset" begin="0.7s" dur="0.2s" values="2;0" />
          </path>
          <path strokeDasharray="2" strokeDashoffset="2" d="M17 17l0.5 0.5M17 7l0.5 -0.5M7 7l-0.5 -0.5M7 17l-0.5 0.5">
            ...
            />
            <animate fill="freeze" attributeName="strokeDashoffset" begin="0.9s" dur="0.2s" values="2;0" />
          </path>
          <animateTransform
...
export const SunRiseIcon: React.FC<IconWrapperProps> = props => {
